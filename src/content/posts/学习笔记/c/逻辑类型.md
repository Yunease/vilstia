...
description: "逻辑类型 基本概念 逻辑类型就是bool型变量，它不能直接使用，需要包含这个库： include <stdbool.h> Bool实际上是利用int来做真假判定的，它会返回两个结果：true或false（代表着1和0），如果强制转换bool类型变量，结果只能是0或1。 使用示例 示例1：条件为..."
---
