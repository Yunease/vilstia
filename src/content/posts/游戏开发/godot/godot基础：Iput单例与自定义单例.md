...
tags: [博客文章, godot]
category: 'godot开发日志'
description: "大家好呀！我是琴泠，之前就有学过一点点godot的开发，但是为了更加系统性，我打算努努力，从更加基础的部分开始掌握学习。这个日志就是我的学习过程啦~相信你这么聪明，只要和我一起努力，也一定可以学会的。 单例 - 单例 - 单例是一个刻意在任何脚本中直接对其访问的对象，分为内置单例与自定义单例。..."
---
