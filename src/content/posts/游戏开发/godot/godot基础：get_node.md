...
tags: [博客文章, godot]
category: 'godot开发日志'
description: "游戏场景中，还需要一些能够进行节点交互的协调工作，就需要用到get_node()，这一集内容，如果您写过前端开发，相信能够很快上手。 使用场景内的根节点的脚本组织场景内节点的工作 - 使用脚本为节点拓展功能是非常常见的操作，但是脚本过多会让文件变得混乱难以管理，应该尽可能减少一个场景内脚本文件..."
---
